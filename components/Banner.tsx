...
function Banner() {
  return (
    <div className="justify-between items-center bg-[url('https://res.cloudinary.com/dz58encu1/image/upload/v1666793434/286590861_378543417641534_6470475454945430459_n_zbvy8f.jpg')]  bg-cover bg-center lg:py-0 saturate-150">
